...
@Component({
  selector: 'app-modifprofilprofessionnel',
  templateUrl: './modifprofilprofessionnel.page.html',
  styleUrls: ['./modifprofilprofessionnel.page.scss'],
})
export class ModifprofilprofessionnelPage implements OnInit {
